...
Use uma vez por tipo presente no relatório. A saída inclui o frontmatter de
identificação relevante, inclusive participantes de Projetos. Evite uma
consulta por observação.
